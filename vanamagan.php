      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            <h2 class="section-heading text-white">Vanamagan albums..</h2>
            <hr class="light my-4">
            <div class="service-box mt-5 mx-auto">
              <img class="img-fluid" src="img/portfolio/fullsize/8.jpg"  height="300" width="200">
              
              <h3 class="text-muted mb-0">Vanamagan</h3>
			  <h5>Dam dam dama dama dum....</h5>
			  <audio controls>
